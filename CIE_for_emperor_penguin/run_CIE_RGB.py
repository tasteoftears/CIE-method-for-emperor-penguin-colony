# Description: Detect emperor penguin colony in remote sensing imagery using B4-B3-B2 bands and chromaticity transformation
...
output_path = os.path.join('output', f'{base_name}_rgb_output.tif')
...
rgb = image[:, :, [3, 2, 1]]  # B4-B3-B2 for RGB composite
...
print(f'[RGB] Output saved: {output_path}')
